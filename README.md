...
本アプリはブラウザから端末にインストールすることができます。

### PC（Chrome / Edge）

1. ブラウザでアプリのページを開きます。
2. アドレスバーの右端に表示される **インストール** アイコン（ ⊕ または画面右上の「…」メニュー内の「アプリをインストール」）をクリックします。
3. 確認ダイアログが表示されたら「インストール」をクリックします。
4. デスクトップまたはスタートメニューにアプリのショートカットが追加されます。

### Android（Chrome）

1. Chrome でアプリのページを開きます。
2. 画面上部または下部に「**ホーム画面に追加**」のバナーが表示されたらタップします。  
   バナーが表示されない場合は、右上の「⋮」メニューから「**ホーム画面に追加**」を選択します。
3. 確認画面で「追加」をタップします。
4. ホーム画面にアプリのアイコンが追加されます。

### iOS（Safari）

1. Safari でアプリのページを開きます。
2. 画面下部の共有ボタン（□に↑のアイコン）をタップします。
3. メニューから「**ホーム画面に追加**」を選択します。
4. 名前を確認して「追加」をタップします。
5. ホーム画面にアプリのアイコンが追加されます。
